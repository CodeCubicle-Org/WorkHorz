...
namespace WHZ {
    ...
    /**
     * @brief Load a resource file and return false if the file could not be loaded. All the file's data is stored in the class
    ...
    /**
     * @brief Free the memory resources for this file by resetting all the member variables
    ...
    bool Resources::unloadResource() {
        ...
        this->_resourceType = ResourceType::UNKNOWN;
        return true;
    }
    ...
    /**
     * @brief Check if the resource file exists and set the internal variables accordingly
    ...
    bool Resources::checkResourceFileExists(std::filesystem::path fpath) {
        ...
        if (std::filesystem::exists(fpath)) {
            ...
            } else if (fpath.extension().string() == ".html" || fpath.extension().string() == ".htm") {
                _resourceType = ResourceType::HTML;
            } else if (fpath.extension().string() == ".whzt") {
                _resourceType = ResourceType::WHZT;
            } else if (fpath.extension().string() == ".js") {
                _resourceType = ResourceType::JS;
            } else if (fpath.extension().string() == ".png") {
                _resourceType = ResourceType::IMAGE_PNG;
            } else if (fpath.extension().string() == ".jpg" || fpath.extension().string() == ".jpeg") {
    ...
    std::optional<ResourceType> Resources::getResourceType() {
